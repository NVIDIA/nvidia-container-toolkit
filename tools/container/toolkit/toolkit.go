...
func Install(cli *cli.Context, opts *options) error {
	...
	err = installToolkitConfig(cli, toolkitConfigPath, nvidiaContainerCliExecutable, nvidiaContainerRuntimeHookPath, nvidiaCTKPath, opts)
	if err != nil && !opts.ignoreErrors {
...
func installToolkitConfig(c *cli.Context, toolkitConfigPath string, nvidiaContainerCliExecutablePath string, nvidiaContainerRuntimeHookPath string, nvidiaCTKPath string, opts *options) error {
