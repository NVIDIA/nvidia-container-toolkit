...
//			},
//			DeviceGetNvLinkInfoFunc: func(device nvml.Device) (nvml.NvLinkInfo, nvml.Return) {
...
func (mock *Interface) DeviceGetNvLinkInfo(device nvml.Device) (nvml.NvLinkInfo, nvml.Return) {
