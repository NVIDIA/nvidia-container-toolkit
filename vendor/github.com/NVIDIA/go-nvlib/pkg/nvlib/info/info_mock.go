...
func (mock *InfoMock) HasDXCore() (bool, string) {
	callInfo := struct {
	}{}
...
//
//	len(mockedInfo.HasDXCoreCalls())
func (mock *InfoMock) HasDXCoreCalls() []struct {
} {
	var calls []struct {
	}
...
func (mock *InfoMock) HasNvml() (bool, string) {
	callInfo := struct {
	}{}
...
// Check the length with:
//
//	len(mockedInfo.HasNvmlCalls())
func (mock *InfoMock) HasNvmlCalls() []struct {
} {
	var calls []struct {
	}
...
func (mock *InfoMock) IsTegraSystem() (bool, string) {
	callInfo := struct {
	}{}
...
// Check the length with:
//
//	len(mockedInfo.IsTegraSystemCalls())
func (mock *InfoMock) IsTegraSystemCalls() []struct {
} {
	var calls []struct {
	}
...
func (mock *InfoMock) UsesNVGPUModule() (bool, string) {
	callInfo := struct {
	}{}
...
// Check the length with:
//
//	len(mockedInfo.UsesNVGPUModuleCalls())
func (mock *InfoMock) UsesNVGPUModuleCalls() []struct {
} {
	var calls []struct {
	}
