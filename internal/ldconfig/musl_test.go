...
func TestCreateMuslPathFilesIfRequired(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			driverDirs:     []string{"/native"},
			systemDirs:     []string{"/lib", "/usr/lib"},
			expectedNative: new("/native\n/lib\n/usr/local/lib\n/usr/lib\n"),
		},
		{
			description:      "driver dirs are prepended to the existing contents",
			isMusl:           true,
			pathFileContents: new("/lib:/usr/local/lib:/usr/lib"),
			driverDirs:       []string{"/native"},
			systemDirs:       []string{"/lib", "/usr/lib"},
			expectedNative:   new("/native\n/lib\n/usr/local/lib\n/usr/lib\n"),
		},
		{
			...
			isMusl:           true,
			pathFileContents: new("/lib\n/usr/local/lib\n/native\n"),
			driverDirs:       []string{"/native"},
			expectedNative:   new("/lib\n/usr/local/lib\n/native\n"),
		},
		{
		...
		},
		{
			...
			isMusl:           true,
			pathFileContents: new("/lib:/usr/local/lib\n/usr/lib"),
			driverDirs:       []string{"/native"},
			expectedNative:   new("/native\n/lib\n/usr/local/lib\n/usr/lib\n"),
		},
		{
